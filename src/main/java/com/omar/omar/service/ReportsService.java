...
public class ReportsService {
    ...
    public List<Moves> getMovesByAccountAndDate(String accountId, LocalDateTime startDate, LocalDateTime endDate) {
        ...
        return movementRepository.findByAccountAndDateBetween(account, startDate, endDate);
    }
}
